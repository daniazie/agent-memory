...
class AgenticMemorySystem:
    ...
    def process_memories(self, notes: List[MemoryNote]) -> tuple:
        ...
        decision_responses = self.llm_controller.generate(decision_prompts)
        notes_to_process = []
        ...
        strengthen_responses = self.llm_controller.generate(strengthen_prompts)
        ...
        update_responses = self.llm_controller.generate(update_prompts)
