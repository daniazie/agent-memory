...
try:
    sentence_model = SentenceTransformer('all-MiniLM-L6-v2', model_kwargs=dict(attn_implementation='flash_attention_4', dtype=torch.float16))
except Exception as e:
    sentence_model = SentenceTransformer('all-MiniLM-L6-v2', model_kwargs=dict(attn_implementation='flash_attention_2', dtype=torch.float16))
except Exception as e:
